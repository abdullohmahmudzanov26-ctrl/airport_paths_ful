...
///
/// Слой чисто декоративный - того же рода, что была погода на обычных
/// уровнях (сейчас убрана): на правила не влияет, только рисует.
/// Частицы лежат в простых List<double>, выделенных один раз в onLoad:
/// внутри кадра не создаётся ни списков, ни кистей.
