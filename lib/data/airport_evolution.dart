...
class AirportEvolution {
  ...
  /// Раз в сколько секунд можно забрать доход - было раз в сутки,
  ...
  /// Награда за один сбор. Раньше это была ЦЕЛАЯ суточная сумма -
  /// при сборе каждые пять минут те же цифры дали бы огромный доход
  /// на голом ожидании. Поэтому сумма за клейм заметно скромнее:
  /// небольшая, но приятная прибавка, ради которой стоит открыть
  /// экран, а не пассивный доход, который выгоднее самих головоломок.
