...
class AirportEvolution {
  ...
  /// Потолок сверху: сколько всего можно заработать из этого источника
  /// за календарный день, сколько бы раз ни забирать банк. Без него
  /// банк в 4 часа, собранный три-четыре раза за день (заглядывать
  /// в игру каждые несколько часов совсем не трудно), давал бы
  /// 10-15 тысяч монет в сутки на верхних уровнях аэропорта - больше,
  /// чем вся кампания из 200 головоломок. Сброс - в полночь по
  /// локальному времени, тем же ключом, что и остальные дневные лимиты.
  static const int dailyEarnCap = 3000;
