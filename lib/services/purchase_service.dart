...
class PurchaseService extends ChangeNotifier {
  ...
  /// Идёт оплата - экран должен заблокировать кнопки, чтобы двойной
  /// тап не отправил два запроса на списание денег.
  ...
  bool canBuy(IapProduct product) =>
      !_processing && (product.consumable || !isOwned(product.id));
