...
class IapProductCard extends StatelessWidget {
  ...
  /// Идёт оплата ИМЕННО ЭТОГО товара - кнопка блокируется. Соседние
  /// карточки каталога получают свой собственный processing (см.
  /// PurchaseService.isProcessingProduct) и не блокируются, пока
  /// покупается что-то другое - раньше все кнопки каталога слушали
  /// один общий флаг и визуально «нажимались» одновременно.
